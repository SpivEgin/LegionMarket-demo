---
title: 'Red Shoes on Sale'
publish_date: '23-01-2016 17:01'
subtitle: 'Ouch, deals this hot are too good to give up'
author:
    name: 'Sideshow Bob'
header_image: '1'
via:
    text: 'The Boss'
    url: '/cardstack/#author/sideshow_bob'
sources:
    1:
        url: 'http://redshoes.com'
        text: 'Red Shoes'
summary:
    enabled: '1'
    strip_tags: '0'
    format: short
header_image_file: brick_road.jpg
taxonomy:
    tag:
        - 'red shoes'
        - sale
...
Get them while they're glowing hot!
